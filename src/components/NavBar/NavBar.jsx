  ...
  return (
    <>
      <nav className=' relative px-8 py-4 flex justify-between items-center border-y border-gray-400 dark:border-gray-700'>
        <div className='w-full flex md:w-9/12 mx-auto'>
          {/* Desktop version */}
          <div className='container fixed top-0 left-0 block justify-between  mx-auto md:flex bg-slate-50'>
            ...
            <div
              className={`items-center  ${
                !show ? 'hidden' : ''
              }  flex-col mt-2 md:mt-0 md:flex-row md:space-x-4  md:flex`}
            >
                ...
                <>
                  <div className='flex flex-col md:flex-row gap-3'>
                    <div className='my-auto'>
                      <button
                        type='button'
                        className='p-2 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-500 dark:text-gray-100 focus:dark:bg-gray-900'
                        onClick={() => {
                          navigate('/new')
                        }}
                      >
                    ...
                    >
                      <NavDropdown.Item className='z-10 relative'>
                        {name}
                      </NavDropdown.Item>
                      <NavDropdown.Divider />
                      <NavDropdown.Item
          ...
          <button
            onClick={() => setHamburger(!show)}
            title='Open menu'
            type='button'
            className=' md:hidden lg:hidden fixed right-3 top-4 text-gray-600'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
