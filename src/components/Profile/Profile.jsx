...
export default function Profile() {
  ...
  return (
    <>
      <NavBar />
      <div className='profile-container px-20 mx-auto'>
                        ...
                        <Card.Body>
                          ...
                          <div className='blog-items'>
                            ...
                            <div>
                              <button
                                type='button'
                                className='p-2 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-500 dark:text-gray-100 hover:bg-gray-600 focus:dark:bg-gray-900'
                                onClick={() => {
                                  handleEdit(blog._id)
                                }}
                              >
                              ...
                              <button
                                type='button'
                                className='p-2 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-red-500 hover:bg-red-600 dark:text-gray-100 focus:dark:bg-gray-900'
                                onClick={() => {
